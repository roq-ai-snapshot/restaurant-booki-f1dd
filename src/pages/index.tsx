  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine v5 - Streamlining your dining experience with seamless table reservations and efficient menu management."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine v5 - Streamlining your dining experience with seamless table reservations and efficient menu management.`}
            </Text>
            <Box
