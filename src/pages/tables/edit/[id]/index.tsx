      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <NumberInput
            ...
            formControlProps={{
              id: 'number_update',
              isInvalid: !!formik.errors?.number_update,
            }}
            name="number_update"
            error={formik.errors?.number_update}
            value={formik.values?.number_update}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('number_update', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
